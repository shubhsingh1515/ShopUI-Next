        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="relative mx-auto w-80 h-[700px] bg-white rounded-[3rem] p-4 shadow-2xl mt-[-10%] mb-[-10%]">
              ...
              {/* Chat header */}
              <div className="flex items-center gap-3 p-4 border-b border-gray-100 text-black">
                ...
                <span className="font-medium">My Support Circle</span>
              ...
              <div className="p-4 border-t border-gray-100">
                <div className="flex items-center gap-2 bg-gray-100 rounded-full px-4 py-2">
                  <input
                    ...
                    readOnly
                  />
                  <button className="w-8 h-8 bg-zabit-primary rounded-full flex items-center justify-center">
